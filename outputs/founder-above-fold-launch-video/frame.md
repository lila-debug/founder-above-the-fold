...
description: >
  ...
  (pink/blue/green/yellow/cream) plus black/white/off-white, Arial Black 800–900 uppercase display +
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Arial Black", cqw: 0.95, weight: 500, lineHeight: 1.6 }
  card-title:{ fontFamily: "Arial Black", cqw: 1.15, weight: 700, upper: true, lineHeight: 1.2 }
  ...
  # — display ramp (Arial Black 800–900, uppercase, negative tracking) —
  heading-md:{ fontFamily: "Arial Black", cqw: 2.1, weight: 700, lineHeight: 1.1, tracking: "-0.01em", upper: true }
  quote-text:{ fontFamily: "Arial Black", cqw: 2.7, weight: 900, lineHeight: 1.15, tracking: "-0.02em", upper: true }
  stat-number:{ fontFamily: "Arial Black", cqw: 3.3, weight: 900, lineHeight: 1.0 }
  heading-lg:{ fontFamily: "Arial Black", cqw: 3.3, weight: 800, lineHeight: 1.0, tracking: "-0.02em", upper: true }
  close-title:{ fontFamily: "Arial Black", cqw: 4.2, weight: 900, lineHeight: 0.95, tracking: "-0.03em", upper: true }
  heading-xl:{ fontFamily: "Arial Black", cqw: 5.0, weight: 900, lineHeight: 0.95, tracking: "-0.03em", upper: true }
...
The voice is **Arial Black** at weight 800–900 in tight uppercase with negative tracking (display) +
...
- **Arial Black 800–900 uppercase** negative-tracked display; **Space Grotesk** label chrome.
...
- **Squint** — one Arial Black display moment dominates at 3–6× its neighbor; cards read as a system, not rivals.
...
Two ramps. The **reading/chrome ramp** (Arial Black body 0.95cqw weight 500, Space Grotesk labels in px)
carries copy + chrome; the **display ramp** (Arial Black `heading-md` 2.1cqw → `heading-xl` 5cqw, weight
...
- **Arial Black display is uppercase, weight 800–900, negative-tracked** (−0.01..−0.03em); body weight 500 sentence case; **Space Grotesk labels uppercase 0.08em**. No sentence-case display, no untracked display.
...
**Ground** `{colors.cream}` (or offwhite) + faint dot-grid. **Composes** label-pill, heading-xl, tilt-deco rect, star-burst, counter. **Focal** a 2–3 line Arial Black `heading-xl` uppercase, left, under a label-pill; tilted pastel rects + a star burst puncture the right. **Chrome** counter pill. **Accent** the decorations' pastels. **Silence** right third holds decorations. **Fixed** 4px/8px coupling, uppercase display, square. **Free** title, decoration placement/colors. **Density** comfortable.
...
**Ground** `{colors.pink}` (or offwhite). **Composes** label-pill, quote-text in a card-elevated, attribution. **Focal** an Arial Black `quote-text` (900 uppercase) inside a white bordered+shadowed frame. **Accent** the ground + one decoration. **Silence** moderate. **Fixed** uppercase quote, 4px/8px. **Free** quote, ground. **Density** comfortable.
...
- Set Arial Black display **uppercase, 800–900, negative-tracked**; open every region with a **label-pill**.
...
- No sentence-case Arial Black display; no untracked display; no label as plain text.
...
- **Squint** — one Arial Black display moment dominates; cards read as a system.
...
- **Type** — Arial Black uppercase 800–900 negative-tracked, fit-to-measure; Space Grotesk labels 0.08em; ≥1.4cqw floor.
...
- **Arial Black + Space Grotesk via Google Fonts.** CJK: Noto Sans SC 900 (sentence case — the uppercase signal drops); lean harder on borders/shadows/decoration to carry the brutalist identity.
